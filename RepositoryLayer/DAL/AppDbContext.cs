...
namespace RepositoryLayer.DAL
{
    public class AppDbContext : IdentityDbContext<AppUser>
    {
        ...
        public DbSet<Adversiment> Adversiments { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Adversiment>().HasQueryFilter(m => !m.SoftDelete);
            ...
            modelBuilder.Entity<Service>().HasQueryFilter(m => !m.SoftDelete);
