...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20230623044100_AddDataToTagsTable")]
    partial class AddDataToTagsTable
    {
            ...
            modelBuilder.Entity("DomainLayer.Entities.Basket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6424),
                            SoftDelete = false
                        },
                        new
                        {
                            ...
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6435),
                            SoftDelete = false
                        });
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Brand", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6561),
                            Image = "01.jpg",
                            Name = "Vegan Lover",
                            SoftDelete = false
                        },
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6562),
                            Image = "03.jpg",
                            Name = "Organic Foody",
                            SoftDelete = false
                        });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6571),
                            Image = "01.jpg",
                            Name = "Vegetables",
                            SoftDelete = false
                        },
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6572),
                            Image = "02.jpg",
                            Name = "Foods",
                            SoftDelete = false
                        });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Discount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6581),
                            Name = "Black Friday",
                            Percent = (byte)50,
                            SoftDelete = false
                        },
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6582),
                            Name = "No Discount",
                            Percent = (byte)0,
                            SoftDelete = false
                        });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BrandId = 1,
                            CategoryId = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6591),
                        ...
                        new
                        {
                            ...
                            BrandId = 2,
                            CategoryId = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6603),
            ...
            modelBuilder.Entity("DomainLayer.Entities.ProductImage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6629),
                            Image = "01.jpg",
                            IsMain = true,
                            ProductId = 1,
                            SoftDelete = false
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6631),
                            Image = "02.jpg",
                            IsMain = false,
                            ProductId = 1,
                            SoftDelete = false
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6632),
                            Image = "03.jpg",
                            IsMain = true,
                            ProductId = 2,
                            SoftDelete = false
                        ...
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6633),
                            Image = "04.jpg",
                            IsMain = false,
                            ProductId = 2,
                            SoftDelete = false
            ...
            modelBuilder.Entity("DomainLayer.Entities.Rating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6674),
                            RatingCount = (byte)1,
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6675),
                            RatingCount = (byte)2,
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6676),
                            RatingCount = (byte)3,
                            SoftDelete = false
                        },
                        new
                        ...
                        {
                            Id = 5,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6677),
                            RatingCount = (byte)5,
                            SoftDelete = false
                        });
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppUserId = "b59d27ed-5ac4-4cbc-819e-c36b80e2d334",
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6685),
                        ...
                        new
                        {
                            Id = 2,
                            AppUserId = "f565482b-e971-4580-8493-e5c5ba0479c9",
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6686),
            ...
            modelBuilder.Entity("DomainLayer.Entities.SubCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6694),
                            Name = "Cucumber",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6695),
                            Name = "Eggplant",
                            SoftDelete = false
                        });
                });
            ...
            modelBuilder.Entity("DomainLayer.Entities.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6704),
                            Name = "Organic",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6705),
                            Name = "Fruits",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6706),
                            Name = "Vegan",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 4,
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6707),
                            Name = "Healthy",
                            SoftDelete = false
                        },
                        new
            ...
            modelBuilder.Entity("DomainLayer.Entities.Wishlist", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppUserId = "b59d27ed-5ac4-4cbc-819e-c36b80e2d334",
                            CreateDate = new DateTime(2023, 6, 23, 8, 41, 0, 363, DateTimeKind.Local).AddTicks(6716),
                            SoftDelete = false
                        },
                        new
                        {
